...
INSERT INTO learners (first_name, last_name, phone, email, level, available, conversation)
VALUES
  ('Sally', 'Shoo', 1111111111, 'email1@email.com', 'esl_novice', false, 1),
  ('Danny', 'Dogg', 2222222222, 'email2@email.com', 'esl_beginner', false, 2),
  ('Eddy', 'Everett', 3333333333, 'email3@email.com', 'esl_intermediate', false, 3),
  ('Patty', 'Patricks', 4444444444, 'email4@email.com', 'citizenship', false, 4),
  ('Thomas', 'Thompson', 5555555555, 'email5@email.com', 'sped_ela', false, 1),
  ('Wendy', 'Wilburg', 6666666666, 'email6@email.com', 'basic_math', true, 2),
  ('Freddy', 'Franks', 7777777777, 'email7@email.com', 'basic_math', true, 3),
  ('Bobby', 'Brown', 8888888888, 'email8@email.com', 'basic_reading', true, 4),
  ('Vinny', 'Vaughn', 9999999999, 'email9@email.com', 'basic_reading', true, null),
  ('Mathew', 'Matters', 1010101010, 'email10@email.com', 'basic_writing', true, null);
```
...
VALUES
  ...
  ('Ashely', 'Adams', 7777777777, 'email17@email.com', true),
